 ...
 * &section=view&do=showConversation&topicID=369068&st=20#msg1489321 TODO Replay
 * .SAP files, https://github.com/epi/sapemu<br/>
 * TODO Large and DD ATRs like SillyPacks<br/>
 ...
 * menu<br/>
 * TODO Implement RAM DISK driver support, PM sent to Jon,
 * http://www.atarimagazines.com/v8n5/SmartRam.html,
 * http://www.atarimagazines.com/startv5n7/ramdisk.html,
 * http://www.atarimagazines
 * .com/software/displayfile.php?file=89-09a/RAMDISK.SRC,
 * http://www.mathyvannisselroy.nl/mydos.htm,
 * "com.wudsn.productions.atari800.thecartstudio\asm\ramdisk" TODO Ramdisk
 * support " Actually typing in "P M", "Pac Man" or "Man Pac
 * " should find it. Only letters and numbers are relevant, order of words should be ignored. That the point of the Google like search. But it looks at some point a bug has creeped in and the space is taken as part of the word instead of the word separator. I'll have a look, but it'll take a while."
 * 
 * @author Peter Dell
 */
