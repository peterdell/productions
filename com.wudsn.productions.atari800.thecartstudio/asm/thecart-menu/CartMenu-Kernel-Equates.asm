...
color3	= $2c7
color4	= $2c8
helpfg	= $02dc	;XL help key flag
ramsiz	= $2e4
memtop	= $2e5	;End of physical RAM (word)
crsinh	= $2f0
chact	= $2f3	;Shadow of chactl ($d401)
chbas	= $2f4
ch	= $2fc

dbsect  = $241 ;Disk boot sector count ($00 = $100)
bootad  = $242 ;Disk boot sector load address
ddevic	= $300	;Device id
dunit	= $301	;Device number
dcomnd	= $302	;Command byte
dstats	= $303	;Status byte
dbuflo	= $304	;Data buffer pointer, lo
dbufhi	= $305	;Data buffer pointer, hi
dtimlo	= $306	;Timout value
dbytlo	= $308	;Number of bytes to transfer, lo
dbythi	= $309	;Number of bytes to transfer, hi
daux1	= $30a	;Sent to device (sector number lo)
daux2	= $30b	;Sent to device (sector number high)
...
; ROM
ciov	= $e456	;Central I/O handler vector
siov	= $e459	;Serial I/O handler vector
...
;===============================================================
	...
	.if :1 / :2 <> (:1 + .len :1 - 1) / :2
		...
		.endif
	.else
		.print ":1 within ",:2," boundary between ", :1, " - ", :1 + .len :1 - 1
	.endif
	.endm
