...
buffer_len		= $38	;Byte, BUFRFL, normally used by SIOV
empty_dl   		= $39	;3 bytes, RECVDN/XMTDON/CHKSNT, normally used by SIOV
fmszpg			= $43	;6 bytes reserved for the File Managing System (FMS)
boot_buffer 		= $700
