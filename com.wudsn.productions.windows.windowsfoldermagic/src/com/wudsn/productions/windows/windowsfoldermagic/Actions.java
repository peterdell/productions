...
public final class Actions extends NLS {
    ...
    public static Action SetDefaultIconFile;
    public static Action SetDefaultIconIndex;
    public static Action SetEmptyIconFile;
    public static Action SetEmptyIconIndex;
    public static Action UpdateFolderIcon;
